...
worldwide (Harvard, Oxford, ..) through their achievements.`
    ...
    }, 
    {
        ...
        paragraphs: [
            `Strong Academic Foundation: students will develop a deep understanding of mathematical concepts. Solid foundation for future academic pursuits.`,
            `Critical Thinking Skills: Expert mentorship fosters critical thinking and problem-solving, essential for success in any field.`,
            `Confidence and Motivation: Personalized support helps build self-confidence and a positive attitude towards learning, motivating students to strive for excellence.`,
            `International Competitiveness: Preparation for international contests and exposure to diverse problem-solving techniques equip students to compete on a global scale.`,
            `Lifelong Learning: The skills and habits developed through expert mentorship extend beyond academics, encouraging a lifelong love for learning and intellectual curiosity.`, 
            `College Readiness: A strong mathematical background, combined with improved English proficiency, enhances college applications and readiness for higher education.`
        ], 
